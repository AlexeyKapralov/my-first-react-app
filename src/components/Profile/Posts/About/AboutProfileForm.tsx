...
export const AboutProfileForm: React.FC<Props> = ({
  post,
  userId,
  setNewProfileData,
}) => {
  ...
  return (
    <div className={styles.wrapper}>
      {post?.userId == userId?.toString() && (
        ...
        >
          <img width={"20px"} src={settingsIcon} alt="settings" />
        </button>
      )}
          ...
          <div className={styles.container}>
            <div>
              ...
              <div className={styles.fieldContent}>
                {post?.fullName || "missing"}
              </div>
            </div>
            <div>
              <div className={styles.fieldTitle}>About me</div>
              <div className={styles.fieldContent}>
                {post?.aboutMe || "missing"}
              </div>
            </div>
            <div>
              <div className={styles.fieldTitle}>Looking for a job</div>
              {post?.lookingForAJob && (
                <div className={styles.fieldContent}>Yes</div>
              )}
              {!post?.lookingForAJob && (
                <div className={styles.fieldContent}>No</div>
              )}
            </div>
            <div>
              ...
              <div className={styles.fieldContent}>
                {post?.lookingForAJobDescription || "missing"}
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className={styles.container}>
            ...
            <div>
              ...
              <input
                className={styles.fieldContentInput}
                defaultValue={String(post?.lookingForAJob)}
                type={"checkbox"}
            ...
            <div>
              ...
              <input
                className={styles.fieldContentInput}
                defaultValue={post?.lookingForAJobDescription}
                placeholder="Looking for a job description"
                {...register("lookingForAJobDescription", { required: true })}
              />
              {errors.lookingForAJobDescription?.type === "required" && (
                <div style={{ color: "red" }} role="alert">
                  Need to write some text
                </div>
              )}
          ...
          <div className={styles.container}>
            ...
            <div>
              ...
              {errors.contacts && (
                <div style={{ color: "red" }}>
                  {errors.contacts?.twitter?.message}
                </div>
              )}
            </div>
            <div>
            ...
            <div>
              ...
              {errors.contacts && (
                <div style={{ color: "red" }}>
                  {errors.contacts?.youtube?.message}
                </div>
              )}
            </div>
            <div>
            ...
            <div>
              ...
              {errors.contacts && (
                <div style={{ color: "red" }}>
                  {errors.contacts?.mainLink?.message}
                </div>
              )}
            </div>
          </div>
